...
function sum(a, b) { //eslint-disable-line
    var c = a + b;
    var aa = [c, 'The sum of ' + a + ' and ' + b + ' is ' + c + '.'];
     dania = c;
    return aa;
}
...
function multiply(a, b) { //eslint-disable-line
    var c = a * b;
    var bb=[c, 'The product of ' + a + ' and ' + b + ' is ' + c + '.'];
    dania = c;
    return bb;
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var resultofsum = sum(a,b);
    var resultof3num= dania+c ;
    var summtion =a+' and '+b+' and '+c+' sum to '+resultof3num+'.';
...
function multiplyArray(multArr) { //eslint-disable-line
    var resultofproarray=multiply(testArray[0],testArray[1]);
    var resultof3proarray=dania*testArray[2];
    var string='The numbers 2,3,4 have a product of '+resultof3proarray+'.';

    return [resultof3proarray,string]
